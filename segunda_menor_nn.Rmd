...
Para ajudar a piorar, aproveitadores pegaram jacaré nessa onda para fazer marketing destrutivo com o intuito de desvalorizar e dividir a comunidade dos analistas de dados. Algo bem similar de marketing malicioso aconteceu com outras palavras da moda como *data science*, *big data*, *Python versus R* e a própria *machine learning*. Antes havia a clássica propaganda de que a empresa X utilizava MACHINE LEARNING em vez de modelos preditivos. Agora a coisa evoluiu e apelam para o uso da palavra Deep Learning.
